...
<div class="w-full max-w-2xl bg-surface-container-lowest rounded-[32px] p-8 md:p-12 shadow-[0_4px_30px_rgba(0,0,0,0.04)]">
    <div class="flex flex-col items-center mb-8">
        ...
        <h1 class="font-headline-lg text-headline-lg text-on-surface text-center">Editar Cliente</h1>
        <p class="font-body-md text-body-md text-on-surface-variant mt-2 text-center">Modifique los datos del cliente.</p>
    </div>
    ...
    <form method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="floating-label-group">
                <input class="w-full h-14 px-4 pt-2 bg-surface-container-low rounded-xl border-none focus:ring-2 focus:ring-primary-container focus:bg-white transition-all duration-300 font-body-md text-body-md outline-none" id="documento" name="documento" placeholder=" " type="text" value="<?php echo htmlspecialchars($cliente['documento']); ?>" required/>
            ...
            <div class="md:col-span-2 floating-label-group">
                <input class="w-full h-14 px-4 pt-2 bg-surface-container-low rounded-xl border-none focus:ring-2 focus:ring-primary-container focus:bg-white transition-all duration-300 font-body-md text-body-md outline-none" id="direccion" name="direccion" placeholder=" " type="text" value="<?php echo htmlspecialchars($cliente['direccion']); ?>"/>
