...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    } elseif(!preg_match("/^[0-9]{8,15}$/", $_POST['documento'])){
        $error = 'El documento debe tener entre 8 y 15 d&iacute;gitos num&eacute;ricos';
...
<div class="w-full max-w-2xl bg-surface-container-lowest rounded-[32px] p-8 md:p-12 shadow-[0_4px_30px_rgba(0,0,0,0.04)]">
    <div class="flex flex-col items-center mb-8">
        <div class="w-16 h-16 bg-secondary-container/30 rounded-full flex items-center justify-center mb-4 text-secondary">
            <span class="material-symbols-outlined text-[32px]" style="font-variation-settings:'FILL'1">person_add</span>
        </div>
        <h1 class="font-headline-lg text-headline-lg text-on-surface text-center">Nuevo Cliente</h1>
        <p class="font-body-md text-body-md text-on-surface-variant mt-2 text-center">Registre un nuevo cliente en el sistema.</p>
    </div>
    ...
    <form method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2 floating-label-group">
                ...
                <label class="font-body-md text-body-md text-outline" for="nombre">Nombre completo</label>
            </div>
            <div class="floating-label-group">
                <input class="w-full h-14 px-4 pt-2 bg-surface-container-low rounded-xl border-none focus:ring-2 focus:ring-primary-container focus:bg-white transition-all duration-300 font-body-md text-body-md outline-none" id="documento" name="documento" placeholder=" " type="text" required/>
                <label class="font-body-md text-body-md text-outline" for="documento">Documento</label>
            </div>
            <div class="floating-label-group">
            ...
            <div class="md:col-span-2 floating-label-group">
                <input class="w-full h-14 px-4 pt-2 bg-surface-container-low rounded-xl border-none focus:ring-2 focus:ring-primary-container focus:bg-white transition-all duration-300 font-body-md text-body-md outline-none" id="direccion" name="direccion" placeholder=" " type="text"/>
                <label class="font-body-md text-body-md text-outline" for="direccion">Direcci&oacute;n</label>
            </div>
        </div>
